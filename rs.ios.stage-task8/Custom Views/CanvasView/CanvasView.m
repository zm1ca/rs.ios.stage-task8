...
- (void)setup {
    ...
    shapeLayer.path = [[self getHeadChinVector] CGPath];
    shapeLayer.fillColor = [[UIColor clearColor] CGColor];
    shapeLayer.strokeColor = [[UIColor blackColor] CGColor];
    shapeLayer.lineWidth = 1.0;
    shapeLayer.position = CGPointMake(61.5, 29);
    [self.layer addSublayer:shapeLayer];
    
    CAShapeLayer *shape2Layer = [[CAShapeLayer alloc] init];
    shape2Layer.path = [[self getLipsHeadVector] CGPath];
    shape2Layer.fillColor = [[UIColor clearColor] CGColor];
    shape2Layer.strokeColor = [[UIColor blackColor] CGColor];
    shape2Layer.lineWidth = 1.0;
    shape2Layer.position = CGPointMake(118, 81);
    [self.layer addSublayer:shape2Layer];
    
    CAShapeLayer *shape3Layer = [[CAShapeLayer alloc] init];
    shape3Layer.path = [[self getHeadNeckVector] CGPath];
    shape3Layer.fillColor = [[UIColor clearColor] CGColor];
    shape3Layer.strokeColor = [[UIColor blackColor] CGColor];
    shape3Layer.lineWidth = 1.0;
    shape3Layer.position = CGPointMake(63.5, 102.5);
